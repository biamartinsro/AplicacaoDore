...
<head>
    ...
    <title>Cadastrar específicos</title>
</head>
    ...
    <div class="row">
        <div class="col s12">
            <div class="input-field col s4 offset-s4">
                ...
                <label for="">Digite o nome do específico: </label>
            </div>
        ...
        <div class="row">
            <div class="col s12">
                <button data-target="modal1" class="btn modal-trigger offset-s3 col s6">Escolha o Submódulo</button>
            </div>
        </div>
