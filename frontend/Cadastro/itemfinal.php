...
<head>
    ...
    <title>Cadastrar Item Final</title>
</head>
...
<h1>Cadastrar Item Final</h1>
<form method="post" action="itemfinal.php" >
    ...
    <div class="input-group">
        ...
        <input type="number" name="especifico" value="">
    </div>
    <div class="input-group">
        <button class="btn" type="submit" name="cadastrar" >Cadastrar</button>
        <button class="btn" name="listar" type="button"
                onclick="location.href='../Interfaces/listaitemfinal.php';">Listar
        </button>
    </div>
</form>
<?php
