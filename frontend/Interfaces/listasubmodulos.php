...
<head>
    ...
    <title>Lista de submódulos</title>
    ...
    <nav class="nav-extended teal z-depth-0">
        ...
        <div class="row">
            <div class="nav-content col s12">
                ...
                <li class="tab active"><a href="listaSubmodulos.html">Submódulos</a></li>
    ...
    <div id="modulos" class="col s12">
        <ul class="collection with-header container">
            <li class="collection-header">
                <a href="../Interfaces de Cadastro/Submodulo.html"><i class="material-icons right medium">add</i></a>
                <h4>Submódulos</h4>
            </li>
            <li class="collection-item">Standard
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href="../Interfaces de Edição/Editar_Submodulo.html"><i class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">Gerador
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">Roteadores
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">Switches
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">Impressoras
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
        </ul>
