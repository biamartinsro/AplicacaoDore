    ...
    <div id="usuarios" class="col s12">
        <ul class="collection with-header container">
            <li class="collection-header">
                <a href="../Cadastro/submodulo.php"><i class="material-icons right medium">add</i></a>
                <h4>Submódulos</h4>
            </li>
            ...
            <?php 
                ...
                <tr>
                    ...
                    <td>
                        <a href="../Edição/editarsubmodulo.php?editar=<?php echo $lst_submodulo->getIdsubmodulo() ?>" class="edit_btn">Alterar</a>
                    </td>
                    <td>
            ...
            <tfoot>
                <td colspan="4" align="center">
                    <br> <button class="btn" name="listar" type="button" onclick="location.href='../Cadastro/submodulo.php';">Cadastrar Submódulo</button>
                </td>
            </tfoot>
        </table>
        <?php
