...
<body>
        ...
        <div class="row">
            <div class="nav-content col s12">
                <ul class="tabs tabs-transparent col s11 offset-s1">
                    ...
                    <li class="tab active"><a href="listaProblemas.html">Problemas</a></li>
    ...
    <div id="modulos" class="col s12">
        <ul class="collection with-header container">
            ...
            <li class="collection-item">Banco de dados não conectado
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href="../Interfaces de Edição/Editar_Problema.html"><i
                        class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">Erro ao inicializar o projeto
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">Computador não liga
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">Fonte queimada
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">Monitor não liga
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
        </ul>
