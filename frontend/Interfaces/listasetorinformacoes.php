...
<head>
    ...
    <title>Lista de setores e informações</title>
...
<body>
        ...
        <div class="row">
            <div class="nav-content col s12">
                <ul class="tabs tabs-transparent col s11 offset-s1">
                    ...
                    <li class="tab active"><a href="listaSetor-Informacoes.html">Setores e Informações</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div id="modulos" class="col s12">
        <ul class="collection with-header container">
            <li class="collection-header">
                <a href="../Interfaces de Cadastro/Setor-Informacoes.html"><i class="material-icons right medium">add</i></a>
                <h4>Setores</h4>
            </li>
            <li class="collection-item">Financeiro
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href="../Interfaces de Edição/Editar_SetorInformacoes.html"><i
                        class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">Produção
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">TI
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">Tesouraria
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
        </ul>
    ...
    <div id="modulos" class="col s12 quadro-informacoes">
        <ul class="collection with-header container">
            <li class="collection-header">
                <a href="../Interfaces de Cadastro/Problema.html"><i class="material-icons right medium">add</i></a>
                <h4>Informações</h4>
            </li>
            <li class="collection-item">Atualização do SAIB
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href="../Interfaces de Edição/Editar_SetorInformacoes.html"><i
                        class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">Atualização do Fortes
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">Manutenção da impressora
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
        </ul>
