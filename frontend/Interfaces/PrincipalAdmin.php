...
<body>
    ...
    <div class="funcoes">
        <div class="opcao">
            <a href="../Interfaces Principais/Modulo.html" class="link">
                <i class="material-icons large funcao">search</i>
            </a>
            <p class="opcoes">Pesquisar</p>

        </div>
        <div class="opcao"><a href="listaUsuários.html" class="link">
                <i class="material-icons large funcao">create</i></a>
            <p class="opcoes">Cadastrar e Editar</p>
