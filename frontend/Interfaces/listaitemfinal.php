        ...
        <div class="row">
            <div class="nav-content col s12">
                <ul class="tabs tabs-transparent col s11 offset-s1">
                    ...
                    <li class="tab active"><a href="listaitemfinal.php">Itens finais</a></li>
    ...
    <div id="usuarios" class="col s12">
        <ul class="collection with-header container">
            <li class="collection-header">
                <a href="../Cadastro/itemfinal.php"><i class="material-icons right medium">add</i></a>
                <h4>Itens Finais</h4>
            </li>
            ...
            <?php 
                ...
                <tr>
                    ...
                    <td>
                        <a href="../Edição/editaritemfinal.php?editar=<?php echo $lst_item->getIditemfinal() ?>" class="edit_btn">Alterar</a>
                    </td>
                    <td>
            ...
            <tfoot>
                <td colspan="4" align="center">
                    <br> <button class="btn" name="listar" type="button" onclick="location.href='../Cadastro/itemfinal.php';">Cadastrar Item Final</button>
                </td>
            </tfoot>
        </table>
        <?php
