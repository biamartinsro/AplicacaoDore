...
<head>
    ...
    <title>Lista de itens finais</title>
    ...
    <nav class="nav-extended teal z-depth-0">
        ...
        <div class="row">
            <div class="nav-content col s12">
                ...
                <li class="tab active"><a href="listaItensFinais.html">Itens finais</a></li>
    ...
    <div id="modulos" class="col s12">
        <ul class="collection with-header container">
            <li class="collection-header">
                <a href="../Interfaces de Cadastro/ItemFinal.html"><i class="material-icons right medium">add</i></a>
                <h4>Itens Finais</h4>
            </li>
            <li class="collection-item">Contatos da memória RAM
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href="../Interfaces de Edição/Editar_ItemFinal.html"><i class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">Tinta dos cartuchoss
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">Disco do HD
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">Fusível das fontes
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
            <li class="collection-item">Parafusos do gabinete
                <a class="modal-trigger" href="#modal"><i class="material-icons right small">delete</i></a>
                <a href=""><i class="material-icons right small">create</i></a>
            </li>
        </ul>
